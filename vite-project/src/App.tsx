...
function App() {
  ...
  const generateVideo = useCallback(async () => {
    ...
    try {
      ...
      setNodes((nds) =>
        nds.map((node) => {
          if (node.id === "video-node-1") {
            // O ID do seu nó de exibição de vídeo
            return {
              ...node,
      ...
      const API_KEY = "bHVjYXNjb250aTE3N0BnbWFpbC5jb20:mBSaPl7DOC4O5sor1JzBf";

      const payload = {
  script: {
    type: "text",
    input: promptValue || "Texto padrão", // evita valor undefined
    provider: {
      type: "microsoft",
      voice_id: "pt-BR-AntonioNeural",
    },
  },
  source_url: "https://models.d-id.com/face/portrait.png",
};
...
// 3. Trate a resposta com segurança:
...
console.log("URL do vídeo:", data.result_url || data.url);
